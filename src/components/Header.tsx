import { MoonIcon, PanelsTopLeftIcon, SettingsIcon, SunIcon } from "lucide-react"; // Settings をインポート
    ...
    <header className="sticky top-0 z-10 backdrop-blur-md bg-white/70 dark:bg-gray-900/70 border-b border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-2">
          <PanelsTopLeftIcon size={24} className="text-blue-600 dark:text-blue-400" />
